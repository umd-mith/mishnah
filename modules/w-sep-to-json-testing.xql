...
declare variable $mCite as xs:string :=  '2.3.10.4';
declare variable $wits as item()* := 'S07326,S00483';
            ...
            return
               ...
               return
                  ...
                  return
                     ...
                     local:h1h2($addDelGroup, 'h2'),console:log(local:h1h2($addDelGroup, 'h2'))),
