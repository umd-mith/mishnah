...
var require$$1 = Object.freeze({
          ...
          var TEIfile = function (_Backbone$Model) {
              ...
              function TEIfile() {
                  ...
                  return possibleConstructorReturn(this, (TEIfile.__proto__ || Object.getPrototypeOf(TEIfile)).apply(this, arguments));
              }
              ...
              createClass(TEIfile, [{
                  ...
                  value: function initialize() {
                      ...
                      CETEIcean.makeHTML5(this.get("data"), function (data) {
          ...
          var TEIfiles = function (_Backbone$Collection) {
              inherits(TEIfiles, _Backbone$Collection);

              function TEIfiles() {
                  classCallCheck(this, TEIfiles);
                  return possibleConstructorReturn(this, (TEIfiles.__proto__ || Object.getPrototypeOf(TEIfiles)).apply(this, arguments));
              }

              createClass(TEIfiles, [{
                  key: 'initialize',
                  value: function initialize(models, files) {
                      var _this2 = this;
                      ...
                      try {
                          var _loop = function _loop() {
                              ...
                              deferreds.push($.ajax({
                                  ...
                                  _this2.add({ "source": source, "data": data });
          ...
          var Reading = function (_Backbone$Model) {
            inherits(Reading, _Backbone$Model);

            function Reading() {
              classCallCheck(this, Reading);
              return possibleConstructorReturn(this, (Reading.__proto__ || Object.getPrototypeOf(Reading)).apply(this, arguments));
            }

            return Reading;
          }(Model);

          var Variant = function (_Backbone$Collection) {
          	inherits(Variant, _Backbone$Collection);

          	function Variant() {
          		classCallCheck(this, Variant);

          		var _this = possibleConstructorReturn(this, (Variant.__proto__ || Object.getPrototypeOf(Variant)).call(this));
          ...
          var Collation = function (_Backbone$Model) {
              inherits(Collation, _Backbone$Model);

              function Collation() {
                  classCallCheck(this, Collation);
                  return possibleConstructorReturn(this, (Collation.__proto__ || Object.getPrototypeOf(Collation)).apply(this, arguments));
              }

              createClass(Collation, [{
                  key: 'initialize',
                  value: function initialize() {
                      var variants = [];
                      var data = this.get("data");
                      var TEIfiles = this.get("TEIfiles");

                      var createReadingData = function createReadingData(rdg) {
                          var $rdg = $(rdg);
                          var source = $rdg.attr('wit').slice(1);
                          var $ptr = $rdg.find("ptr");
                          if ($ptr.length == 0) {
                              return {
                                  "source": source,
                                  "idref": "",
                          ...
                          var idref = $rdg.find("ptr").attr("target").split("#")[1];
                          if ($(TEIfiles.where({ source: source })).length == 0) {
                              return {
                                  "source": source,
                                  "idref": "",
                                  "elementRef": "",
                          ...
                          var elementRef = $(TEIfiles.where({ source: source })[0].get("html5")).find('*').filter(function () {
                              return $(this).attr("xml:id") == idref;
                          });
                          var text = elementRef.text();
                      ...
                      $(data).find("app").each(function (i_a, app) {
                          ...
                          $(app).children().each(function (i_rg, reading) {
                              if (reading.tagName == "rdg") {
                                  ...
                                  try {
                                      for (var _iterator = toCreate[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                                          var r = _step.value;
          ...
          var TextView = function (_Backbone$View) {
              ...
              function TextView() {
                  ...
                  return possibleConstructorReturn(this, (TextView.__proto__ || Object.getPrototypeOf(TextView)).apply(this, arguments));
              }
          ...
          var ReadingView = function (_Backbone$View) {
              inherits(ReadingView, _Backbone$View);

              function ReadingView() {
                  classCallCheck(this, ReadingView);
                  return possibleConstructorReturn(this, (ReadingView.__proto__ || Object.getPrototypeOf(ReadingView)).apply(this, arguments));
              }

              createClass(ReadingView, [{
                  key: 'initialize',
          ...
          var VariantsView = function (_Backbone$View) {
              inherits(VariantsView, _Backbone$View);

              function VariantsView() {
                  classCallCheck(this, VariantsView);
                  return possibleConstructorReturn(this, (VariantsView.__proto__ || Object.getPrototypeOf(VariantsView)).apply(this, arguments));
              }

              createClass(VariantsView, [{
                  key: 'initialize',
                  value: function initialize(options) {
                      this.source = options.source;
                  ...
                  key: 'render',
                  value: function render() {
                      var sourceid = this.source.get("source");
                      ...
                      try {
                          for (var _iterator = this.variants[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                              ...
                              new ReadingView({ "collection": variant, "source": sourceid }).render();
                          }
                      } catch (err) {
                          _didIteratorError = true;
                          _iteratorError = err;
          ...
          var MTV = function (_Backbone$View) {
                    ...
                    function MTV() {
                              ...
                              return possibleConstructorReturn(this, (MTV.__proto__ || Object.getPrototypeOf(MTV)).apply(this, arguments));
                    }
                    ...
                    createClass(MTV, [{
                              ...
                              value: function initialize(options) {
                                        ...
                                        this.listenTo(this.TEIfiles_coll, 'sync', function () {
                                                  _this2.$el.append("<h2>Loading variants...</h2>");
                                                  $.ajax(_this2.collation).success(function (data) {
                                                            _this2.TEIcollation = new Collation({ "data": data, "TEIfiles": _this2.TEIfiles_coll });
                                                  }).done(function () {
                                                            _this2.$el.append("Ready.");
                                                            ...
                                                            var model = null;
                                                            if (!_this2.base) {
                                                                      model = _this2.TEIfiles_coll.first();
                                                            } else {
                                                                      model = _this2.TEIfiles_coll.where({ "source": _this2.base })[0];
                                                            }

                                                            new TextView({ "model": model, "el": _this2.el }).render();

                                                            new VariantsView({ "model": _this2.TEIcollation, "source": model, "el": _this2.el }).render();
                                                  });
                                        });
                              }
                    }]);
          ...
          $(function () {
              var baseDir = '/tei/w-sep/';
              new MTV({ "files": [baseDir + 'S07326-w-sep.xml', baseDir + 'S00483-w-sep.xml', baseDir + 'S01520-w-sep.xml'],
                  "base": "S07326-w-sep",
