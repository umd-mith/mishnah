        ...
        <footer id="footer" class="footer-wrap">
          ...
          <div class="footer">
            <div class="info">
              ...
              <div class="fr">Developed by Hayim Lapin with support from the <a
                  href="http://mith.umd.edu/" title="MITH" target="_blank">Maryland Institute of
                  Technology in the Humanities (MITH)</a>.</div>
            </div>
