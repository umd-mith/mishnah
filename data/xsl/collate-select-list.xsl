...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <div class="about" stye="clear:both" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <xsl:template name="buttons">
        <xsl:choose>
            <xsl:when test="$unit = 'all' or $unit = ''">
                ...
                <div class="radio">
                    <input id="align" class="radio" type="radio"
                        disabled="disabled" name="alignType"/>
                    <label for="align">Alignment</label>
                    <br/>
                    <input id="synopsis" class="radio" type="radio"
                        disabled="disabled" name="alignType" value="synopsis"/>
                    <label for="synopsis">Synopsis</label>
                    <br/>
                    <input id="apparatus" class="radio" type="radio"
            ...
            <xsl:otherwise>
                ...
                <div class="radio">
                    <input id="align" class="radio" type="radio" value="align"
                        name="alignType">
