                    ...
                    <xsl:when test="substring-after($testRows/*:nextRow,'ana')!='1'">
                        ...
                        <seg type="analysisGroup">
                            ...
                            <w type="token"
                                ...
                                <xsl:value-of select="$cells/*:MAIN"/>
                            </w>
                    ...
                    <xsl:choose>
                        ...
                        <xsl:when test="@type='base'">
                            ...
                            <xsl:attribute name="feats">
                                ...
                                <!-- gender -->
                                <xsl:choose>
                                    <xsl:when test="$cells/*:Gen='masculine'">
                                        <xsl:text> m:M</xsl:text>
                                    </xsl:when>
                                    <xsl:when test="$cells/*:Gen='feminine'">
                                        <xsl:text> m:F</xsl:text>
                                    </xsl:when>
                                    <xsl:when test="$cells/*:Gen='masculine_and_feminine'">
                                ...
                                <!-- number -->
                                <xsl:choose>
                                    <xsl:when test="$cells/*:Num='singular'">
                                        <xsl:text> m:S</xsl:text>
                                    </xsl:when>
                                    <xsl:when test="$cells/*:Num='dual'">
                                        <xsl:text> m:D</xsl:text>
                                    </xsl:when>
                                    <xsl:when test="$cells/*:Num='plural'">
                                        <xsl:text> m:P</xsl:text>
                                    </xsl:when>
                                    <xsl:when test="$cells/*:Num='singular_and_plural'">
                                        <xsl:text> m:SandP</xsl:text>
                                    </xsl:when>
                                    <xsl:when test="$cells/*:Num='dual_and_plural'">
                                        <xsl:text> m:DandP</xsl:text>
                                    </xsl:when>
                                    <xsl:when test="string($cells/*:Num)">
